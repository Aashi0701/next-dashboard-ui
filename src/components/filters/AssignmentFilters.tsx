  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex items-center gap-2 px-2 py-1.5 text-sm rounded-2xl bg-purple-500 text-white hover:bg-indigo-500 transition"
      >
        <Image src="/filter1.png" width={18} height={18} alt="filter" />
        Filter
      </button>
