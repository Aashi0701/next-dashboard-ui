      ...
      {open && (
        <div className="absolute right-0 mt-2 w-28 md:w-44 bg-white border shadow-lg rounded-md z-40">
          <div className="py-1 text-[10px] text-gray-700">
            ...
            <button onClick={() => toggleSort("class")} className="block w-full text-left px-3 py-1.5 hover:bg-gray-100">
              Sort by Class
            </button>

            <button onClick={() => toggleSort("teacher")} className="block w-full text-left px-3 py-1.5 hover:bg-gray-100">
              Sort by Teacher
            </button>

            <button onClick={() => toggleSort("date")} className="block w-full text-left px-3 py-1.5 hover:bg-gray-100">
              Newly Added
            </button>
